package com.luinel.beprepared.exception.handler;

import com.luinel.beprepared.exception.BadRequestException;
import com.luinel.beprepared.exception.EntityNotFoudException;
...
public class APExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex,
        ...
        response.setTitle("ERRO DE VALIDAÇÃO DE DADOS! Um ou mais campos estão invalidos!");
    ...
    public ResponseEntity<Object> handleEntityNotFoudException(BadRequestException ex, HttpServletRequest request) {

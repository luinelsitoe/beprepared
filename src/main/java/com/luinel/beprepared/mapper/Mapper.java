package com.luinel.beprepared.mapper;

import com.luinel.beprepared.dto.request.AlertRequestDto;
import com.luinel.beprepared.dto.request.CitizenRequestDto;
import com.luinel.beprepared.dto.request.UserRequestDto;
import com.luinel.beprepared.dto.response.*;
import com.luinel.beprepared.model.*;
...
public class Mapper {
    ...
    public ProvinceResponseDto mapToProvinceResponseDto(Province province) {
        return modelMapper.map(province, ProvinceResponseDto.class);
    }

    public List<ProvinceResponseDto> mapToProvinceResponseDtoList(List<Province> provinces) {
        return provinces.stream().map(this::mapToProvinceResponseDto)
                .collect(Collectors.toList());
    }

    public CityRespondeDto mapToCityRespondeDto(City city) {
        return modelMapper.map(city, CityRespondeDto.class);
    }

    public List<CityRespondeDto> mapToCityRespondeDtoList(List<City> cities) {
        return cities.stream().map(this::mapToCityRespondeDto)
                .collect(Collectors.toList());
    }
